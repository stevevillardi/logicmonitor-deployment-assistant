...
export const CollectorVisualization = ({ 
    ...
    const getLoadColor = (load: number) => {
        if (load >= 80) return "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-800 text-red-700 dark:text-red-400";
        if (load >= 60) return "bg-yellow-50 dark:bg-yellow-900/30 border-yellow-200 dark:border-yellow-800 text-yellow-700 dark:text-yellow-400";
        return "bg-emerald-50 dark:bg-emerald-900/30 border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400";
    };
    ...
    const renderCollectorGroup = (
        ...
        return (
            <div className={`border rounded-lg p-4 sm:p-6 bg-white dark:bg-gray-800 shadow-sm ${borderColor}`}>
                <div className="mb-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                        <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-50 flex items-center gap-2">
                            {icon}
                            {title}
                        </h3>

                        <div className="grid grid-cols-2 sm:flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                            <div className="px-2 sm:px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-400 flex items-center gap-1.5">
                            ...
                            <div className="px-2 sm:px-3 py-2 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 flex items-center gap-1.5">
                                <div className="flex flex-col">
                                    <span className="text-xs font-medium">Avg Load</span>
                                    <span className="text-sm font-bold">{metrics.avgLoad}%</span>
                                </div>
                            </div>
                            <div className="px-2 sm:px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
                                <div className="flex flex-col">
                ...
                <div className="space-y-2">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        {collectors.length === 0 ? (
                            <div className="col-span-1 sm:col-span-2 flex items-center justify-center p-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700">
                                ...
                                >
                                    ...
                                    {collector.type !== "N+1 Redundancy" && (
                                        <div className="flex items-center gap-2 w-full sm:w-auto">
                                            ...
                                            <div className="w-full sm:w-16 bg-white/80 dark:bg-gray-700/80 border border-gray-200 dark:border-gray-600 rounded-full h-1.5">
                                                <div
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-medium text-blue-900 dark:text-blue-50">Polling Collectors</h3>
                    </div>
            ...
            <div className="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-medium text-orange-900 dark:text-orange-50">Logs Collectors</h3>
                    </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-medium text-purple-900 dark:text-purple-50">NetFlow Collectors</h3>
                    </div>
