...
export const LogsInput = ({ logs, onUpdate, showDetails = false }: LogsInputProps) => {
    ...
    const renderSectionHeader = (
        ...
        <div 
            className="flex items-center justify-between bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800"
        ...
        >
            ...
            <div className="flex items-center gap-4">
                <div className="px-3 py-1 bg-blue-50 dark:bg-gray-800 rounded-full">
                    <span className="text-sm text-blue-700 dark:text-blue-300">{calculateSectionDevices(section)} devices</span>
                </div>
                <div className="px-3 py-1 bg-emerald-50 dark:bg-gray-800 rounded-full">
    ...
    const renderDeviceCard = (key: string, value: any, icon: JSX.Element) => (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    ...
                    <Input
                        ...
                        className="mt-2 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 dark:text-gray-100"
                ...
                {showDetails && (
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="px-3 py-1 bg-blue-50 dark:bg-gray-800 text-blue-700 dark:text-blue-300 rounded-full text-sm font-medium">
                                {value.eps || value.fps}
                            </div>
                        </div>
                        <div className="flex items-center justify-between">
