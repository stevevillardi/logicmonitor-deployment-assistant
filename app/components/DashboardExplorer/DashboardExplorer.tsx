                            ...
                            <div className="flex items-center gap-3">
                                {user ? (
                                    <Button
                                        ...
                                        className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 gap-2"
                                    >
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <Button
                                                        ...
                                                        className="bg-white dark:bg-gray-900 border-blue-200 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-gray-800 text-blue-700 dark:text-blue-300"
                                                        disabled={isLoading}
                                                    >
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                        {currentDashboards.map((dashboard) => (
                                            <DashboardMiniPreview key={dashboard.path} dashboard={dashboard.content}>
                                                <div className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md transition-all relative">
                                                    <div className="flex justify-between items-start">
                                                        <div className="flex-1">
                                                            <div className="flex items-center justify-between">
                                                                <h3 
                                                                    className={`text-lg font-semibold text-blue-900 dark:text-gray-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors cursor-pointer ${
                                                                ...
                                                                >
                                                                    ...
                                                                    {dashboard.path.includes('Previous') && (
                                                                        <span className="ml-2 text-xs font-normal text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20 px-2 py-0.5 rounded-full">
                                                                            Previous
                                                                        </span>
                                                                    )}
                                                                </h3>
                                                                <span className="px-2 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 text-xs font-medium rounded-full">
                                                                    {dashboard.category}
                                                                </span>
                                                            </div>
                                                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 line-clamp-2">{dashboard.description}</p>
                                                            <div className="flex items-center gap-4 mt-3">
                                                                <span className="text-xs bg-blue-50 text-blue-700 dark:text-blue-300 px-2 py-1 rounded-full">
